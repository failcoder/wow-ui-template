...
local GetAchievementRow = function(self, index)
	if(not self.Rows[index]) then
		...
		row.Badge.Icon:SetTexCoord(unpack(_G.CUSTOM_UI_ICON_COORDS))
...
function MOD:InitializeAchievements()
	...
	achievements.Header.Text:SetFontObject(CUSTOM_UI_Font_Quest_Header);
	...
	achievements.Header.Divider:SetTexture([[Interface\AddOns\CUSTOM_UI\media\textures\DROPDOWN-DIVIDER]]);
	...
	UI.Events:On("QUEST_UPVALUES_UPDATED", UpdateAchievementLocals, true);
end
