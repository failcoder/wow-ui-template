...
modified/minimally re-written for CUSTOM_UI by Munglunch
...
function MOD:InitializeQuestItem()
	CUSTOM_UI_QuestItemBar:SetParent(UI.Screen)
	CUSTOM_UI_QuestItemBar:SetPoint("BOTTOM", UI.Screen, "BOTTOM", 0, 250)
	CUSTOM_UI_QuestItemBar:SetSize(40,40)

	UI:NewAnchor(CUSTOM_UI_QuestItemBar, L["Quest Item Button"])

	local questitem = UI:CreateSecureButton("item", "CUSTOM_UI_QuestItemBar", "CUSTOM_UI_QuestAutoItemButton", UpdateButton);
