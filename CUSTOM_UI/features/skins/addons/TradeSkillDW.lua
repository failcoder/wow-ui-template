...
local function StyleTradeSkillDW()
	...
	TradeSkillListScrollFrame:RemoveTextures(true)
	UI.API:Set("Frame", TradeSkillGuildFrame,"Transparent")
	UI.API:Set("Frame", TradeSkillGuildFrameContainer,"Transparent")
	TradeSkillGuildFrame:SetPoint("BOTTOMLEFT", TradeSkillFrame, "BOTTOMRIGHT", 3, 19)
	UI.API:Set("CloseButton", TradeSkillGuildFrameCloseButton)

	TradeSkillFrame:HookScript("OnShow", function()
		UI.API:Set("Frame", TradeSkillFrame)
		...
		if not TradeSkillDWExpandButton.styled then
			UI.API:Set("PageButton", TradeSkillDWExpandButton)
	...
	TradeSkillRankFrame:SetStatusBarTexture(UI.Media.statusbar.default)
	...
	UI.API:Set("Frame", TradeSkillLinkButton,"Transparent")
	...
	UI.API:Set("CloseButton", TradeSkillFrameCloseButton)
	UI.API:Set("ScrollBar", TradeSkillDetailScrollFrameScrollBar)
	...
	hooksecurefunc("TradeSkillFrame_SetSelection", function(id)
		...
		for i = 1, MAX_TRADE_SKILL_REAGENTS do
			...
			if not icon.backdrop then
				...
				UI.API:Set("Frame", icon.backdrop,"Transparent")
	...
	TradeSkillDW_QueueFrame:HookScript("OnShow", function() UI.API:Set("Frame", TradeSkillDW_QueueFrame,"Transparent") end)

	UI.API:Set("CloseButton", TradeSkillDW_QueueFrameCloseButton)
	...
	UI.API:Set("ScrollBar", TradeSkillDW_QueueFrameDetailScrollFrameScrollBar)
	TradeSkillListScrollFrame:RemoveTextures()
end
--[[#################################################]]--
