...
local function StyleOutfitter()
	...
	OutfitterFrame:HookScript("OnShow", function(self) 
		UI.API:Set("Frame", OutfitterFrame)
	...
	UI.API:Set("ScrollBar", OutfitterMainFrameScrollFrameScrollBar)
	UI.API:Set("CloseButton", OutfitterCloseButton)
	...
	UI.API:Set("ScrollBar", OutfitterEditScriptDialogSourceScriptScrollBar)
	UI.API:Set("Frame", OutfitterEditScriptDialogSourceScript,"Transparent")
	UI.API:Set("Frame", OutfitterEditScriptDialog)
	UI.API:Set("CloseButton", OutfitterEditScriptDialog.CloseButton)
	UI.API:Set("Tab", OutfitterEditScriptDialogTab1)
	UI.API:Set("Tab", OutfitterEditScriptDialogTab2)
end
