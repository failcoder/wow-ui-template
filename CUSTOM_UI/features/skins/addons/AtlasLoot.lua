...
local function Nine_IsThere(self, elapsed)
	...
	for _, object in pairs(nineisthere) do UI.API:Set("Frame", _G[object]) end 
...
local function StyleAtlasLoot(event, addon)
	...
	for _, object in pairs(SetTemplateDefault) do UI.API:Set("Frame", _G[object], "Default")end 
	for _, button in pairs(buttons) do _G[button]:SetStyle("Button")end 

	-- Manipulate the main frames
	UI.API:Set("Frame", _G["AtlasLootDefaultFrame"], "Window2");
	UI.API:Set("!_Frame", _G["AtlasLootItemsFrame"], "Inset");
	UI.API:Set("Frame", _G["AtlasLootPanel"], "Default");
	...
	-- Back to the rest
	UI.API:Set("Frame", _G["AtlasLootCompareFrame"], "Transparent");
	...
	UI.API:Set("CloseButton", AtlasLootDefaultFrame_CloseButton)
	UI.API:Set("CloseButton", AtlasLootCompareFrame_CloseButton)
	UI.API:Set("CloseButton", AtlasLootCompareFrame_CloseButton_Wishlist)
	UI.API:Set("PageButton", AtlasLootQuickLooksButton)
	UI.API:Set("PageButton", AtlasLootItemsFrame_NEXT)
	AtlasLootItemsFrame_NEXT:SetWidth(25)
	AtlasLootItemsFrame_NEXT:SetHeight(25)
	UI.API:Set("PageButton", AtlasLootItemsFrame_PREV)
	AtlasLootItemsFrame_PREV:SetWidth(25)
	AtlasLootItemsFrame_PREV:SetHeight(25)
	UI.API:Set("PageButton", AtlasLootPanelSearch_SelectModuel)	
	UI.API:Set("PageButton", AtlasLootCompareFrameSearch_SelectModuel)

	if(AtlasLootDefaultFrame_PackageSelect) then
		UI.API:Set("DropDown", AtlasLootDefaultFrame_PackageSelect)
	...
	UI.API:Set("DropDown", AtlasLootDefaultFrame_ModuleSelect,240)
	UI.API:Set("DropDown", AtlasLootDefaultFrame_InstanceSelect,240)
	
	UI.API:Set("DropDown", AtlasLootCompareFrameSearch_StatsListDropDown)
	AtlasLootCompareFrameSearch_StatsListDropDown:SetWidth(240)
	UI.API:Set("DropDown", AtlasLootCompareFrame_WishlistDropDown)
	...
	UI.API:Set("ScrollBar", AtlasLootCompareFrame_ScrollFrameItemFrameScrollBar)
	UI.API:Set("ScrollBar", AtlasLootCompareFrame_WishlistScrollFrameScrollBar)
	...
	if(AtlasLootTooltip:GetName() ~= "GameTooltip") then 
		UI.API:Set("Tooltip", AtlasLootTooltip)
	end
end
