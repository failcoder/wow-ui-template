...
local function StyleLightHeaded()
	...
	UI.API:Set("Frame", LightHeadedFrame)
	UI.API:Set("Frame", LightHeadedFrameSub)
	UI.API:Set("Frame", LightHeadedSearchBox)
	UI.API:Set("Tooltip", LightHeadedTooltip)
	LightHeadedScrollFrame:RemoveTextures()
			
	lhframe.close:Hide()
	UI.API:Set("CloseButton", lhframe.close)
	lhframe.handle:Hide()
	
	UI.API:Set("PageButton", lhsub.prev)
	UI.API:Set("PageButton", lhsub.next)
	...
	UI.API:Set("ScrollBar", LightHeadedScrollFrameScrollBar, 5)
