...
local function StyleACP()
	...
	UI.API:Set("Frame", ACP_AddonList)
	UI.API:Set("Frame", ACP_AddonList_ScrollFrame)
	...
	UI.API:Set("CloseButton", ACP_AddonListCloseButton)
	for c=1,20,1 do 
	...
	UI.API:Set("ScrollBar", ACP_AddonList_ScrollFrameScrollBar)
	UI.API:Set("DropDown", ACP_AddonListSortDropDown)
