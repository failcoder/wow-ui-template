...
local function StyleRecount()
	...
	UI.API:Set("ScrollBar", Recount_MainWindow_ScrollBarScrollBar)
	...
	Recount.MainWindow.FileButton:HookScript('OnClick', function(self) if LibDropdownFrame0 then UI.API:Set("Frame", LibDropdownFrame0) end end)
	...
	hooksecurefunc(Recount, 'ShowReport', function(self)
		...
		UI.API:Set("Frame", Recount_ReportWindow.Whisper)
		Recount_ReportWindow.ReportButton:SetStyle("Button")
		UI.API:Set("ScrollBar", Recount_ReportWindow_Slider)
