...
local function TradeSkillStyle()
	if UI.db.Skins.blizzard.enable ~= true or UI.db.Skins.blizzard.tradeskill ~= true then
		 return 
	end
	...
	UI.API:Set("Window", TradeSkillFrame, true, true)
	UI.API:Set("Window", TradeSkillGuildFrame)
	...
	UI.API:Set("ScrollBar", TradeSkillListScrollFrameScrollBar)
	...
	UI.API:Set("PageButton", TradeSkillDecrementButton)
	UI.API:Set("PageButton", TradeSkillIncrementButton)
	...
	hooksecurefunc("TradeSkillFrame_SetSelection", function(_)
		...
		if TradeSkillSkillIcon:GetNormalTexture() then
			TradeSkillSkillIcon:GetNormalTexture():SetTexCoord(unpack(_G.CUSTOM_UI_ICON_COORDS))
		end 
