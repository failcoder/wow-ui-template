...
local function BarberShopStyle()
	if UI.db.Skins.blizzard.enable~=true or UI.db.Skins.blizzard.barber~=true then return end
	...
	for i = 1, 5 do 
		...
		if selector then
			UI.API:Set("PageButton", _G["BarberShopFrameSelector"..i.."Prev"])
			UI.API:Set("PageButton", _G["BarberShopFrameSelector"..i.."Next"])
