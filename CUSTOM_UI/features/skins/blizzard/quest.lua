...
local function StyleQuestRewards()
	...
	for i = 1, 10 do
		...
		UI.API:Set("!_QuestItem", _G[name])
	end
	if(rewardsFrame:GetName() == 'MapQuestInfoRewardsFrame') then
		UI.API:Set("!_QuestItem", rewardsFrame.XPFrame)
		UI.API:Set("!_QuestItem", rewardsFrame.SpellFrame)
		UI.API:Set("!_QuestItem", rewardsFrame.MoneyFrame)
		UI.API:Set("!_QuestItem", rewardsFrame.SkillPointFrame)
		UI.API:Set("!_QuestItem", rewardsFrame.PlayerTitleFrame)
	end
end
...
local function QuestFrameStyle()
	if UI.db.Skins.blizzard.enable ~= true or UI.db.Skins.blizzard.quest ~= true then return end

	UI.API:Set("Window", QuestLogPopupDetailFrame, true, true)
	UI.API:Set("Window", QuestFrame, true, true)
	...
	UI.API:Set("Window", QuestLogPopupDetailFrame)
	...
	UI.API:Set("CloseButton", QuestLogPopupDetailFrameCloseButton)
	UI.API:Set("ScrollBar", QuestLogPopupDetailFrameScrollFrameScrollBar, 5)
	UI.API:Set("ScrollBar", QuestRewardScrollFrameScrollBar)

	QuestGreetingScrollFrame:RemoveTextures()
	UI.API:Set("ScrollBar", QuestGreetingScrollFrameScrollBar)
	...
	QuestInfoSkillPointFrameIconTexture:SetTexCoord(unpack(_G.CUSTOM_UI_ICON_COORDS))
	...
	UI.API:Set("CloseButton", QuestFrameCloseButton, QuestFrame.Panel)
	...
	UI.NPC:Register(QuestFrame, QuestFrameNpcNameText)
end

local function QuestChoiceFrameStyle()
	if UI.db.Skins.blizzard.enable ~= true or UI.db.Skins.blizzard.quest ~= true then return end

	UI.API:Set("Window", QuestChoiceFrame, true, true)
	...
	UI.API:Set("CloseButton", QuestChoiceFrame.CloseButton)
