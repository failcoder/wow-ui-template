...
local function ChangeTabHelper(this, xOffset, yOffset)
  this:SetNormalTexture(UI.NoTexture)
  this:SetPushedTexture(UI.NoTexture)
  this:SetDisabledTexture(UI.NoTexture)
  this:SetHighlightTexture(UI.NoTexture)
...
local function EncounterJournalStyle()
	if UI.db.Skins.blizzard.enable ~= true or UI.db.Skins.blizzard.encounterjournal ~= true then
		 return
	end
  ...
  UI.API:Set("EditBox", EncounterJournalSearchBox)
  ...
  UI.API:Set("ScrollBar", EncounterJournalInstanceSelectScrollFrame)
  UI.API:Set("ScrollBar", EncounterJournalEncounterFrameInfoBossesScrollFrame)
  UI.API:Set("ScrollBar", EncounterJournalEncounterFrameInfoOverviewScrollFrame)
  UI.API:Set("ScrollBar", EncounterJournalEncounterFrameInfoLootScrollFrame)
  UI.API:Set("ScrollBar", EncounterJournalEncounterFrameInfoDetailsScrollFrame)
  UI.API:Set("DropDown", EncounterJournalInstanceSelectTierDropDown)
  UI.API:Set("CloseButton", EncounterJournalCloseButton)
