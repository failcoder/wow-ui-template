...
local function WorldMap_SmallView()
  ...
  if(CUSTOM_UI_WorldMapCoords) then
    CUSTOM_UI_WorldMapCoords:SetPoint("BOTTOMLEFT", WorldMapFrame, "BOTTOMLEFT", 5, 5)
  end
end
...
local function StripQuestMapFrame()
  ...
  UI.API:Set("ScrollBar", QuestMapDetailsScrollFrameScrollBar)
  UI.API:Set("Skin", QuestMapFrame.DetailsFrame.RewardsFrame, 0, -10, 0, 0)
...
local function WorldMap_OnShow()
  ...
  -- WorldMap_SmallView()
  if not UI.db.Maps.tinyWorldMap then
...
local function WorldMapStyle()
  if UI.db.Skins.blizzard.enable ~= true or UI.db.Skins.blizzard.worldmap ~= true then return end

  UI.API:Set("Window", WorldMapFrame, true, true)
  --WorldMapFrame.Panel:SetStyle("Frame", "Transparent")

  UI.API:Set("ScrollBar", QuestScrollFrameScrollBar)
  UI.API:Set("ScrollBar", WorldMapQuestScrollFrameScrollBar)
  UI.API:Set("ScrollBar", WorldMapQuestDetailScrollFrameScrollBar, 4)
  UI.API:Set("ScrollBar", WorldMapQuestRewardScrollFrameScrollBar, 4)
  ...
  UI.API:Set("CloseButton", WorldMapFrameCloseButton)
  UI.API:Set("ArrowButton", WorldMapFrameSizeDownButton, "down")
  UI.API:Set("ArrowButton", WorldMapFrameSizeUpButton, "up")

  UI.API:Set("DropDown", WorldMapLevelDropDown)
  UI.API:Set("DropDown", WorldMapZoneMinimapDropDown)
  UI.API:Set("DropDown", WorldMapContinentDropDown)
  UI.API:Set("DropDown", WorldMapZoneDropDown)
  UI.API:Set("DropDown", WorldMapShowDropDown)
  ...
  --UI.API:Set("InfoButton", WorldMapFrameTutorialButton)
  --WorldMapFrameTutorialButton:SetPoint("LEFT", WorldMapFrameNavBar.Panel, "RIGHT", -50, 0)
