...
local function InspectStyle()
	if UI.db.Skins.blizzard.enable ~= true or UI.db.Skins.blizzard.inspect ~= true then
		return 
	end 
	InspectFrame:RemoveTextures(true)
	InspectFrameInset:RemoveTextures(true)
	InspectFrame:SetStyle("Frame", "Window2")
	UI.API:Set("CloseButton", InspectFrameCloseButton)
	for d = 1, 4 do
		UI.API:Set("Tab", _G["InspectFrameTab"..d])
	end 
