...
local function ChatStyle()
	if UI.db.Skins.blizzard.enable ~= true or UI.db.Skins.blizzard.chat ~= true then
		 return
	end
	...
	UI.API:Set("PageButton", ChatConfigMoveFilterUpButton,true)
	UI.API:Set("PageButton", ChatConfigMoveFilterDownButton,true)
	UI.API:Set("PageButton", CombatLogQuickButtonFrame_CustomAdditionalFilterButton,true)

	UI.API:Set("ScrollBar", CUSTOM_UI_CopyChatScrollFrameScrollBar)
	UI.API:Set("CloseButton", CUSTOM_UI_CopyChatFrameCloseButton)
