...
local function RaidUIStyle()
	...
	if UI.db.Skins.blizzard.enable ~= true or UI.db.Skins.blizzard.raid ~= true then return end 
...
local function RaidInfoStyle()
	if UI.db.Skins.blizzard.enable ~= true or UI.db.Skins.blizzard.nonraid ~= true then
		return 
	end
	...
	UI.API:Set("CloseButton", RaidInfoCloseButton, RaidInfoFrame)
	UI.API:Set("ScrollBar", RaidInfoScrollFrameScrollBar)
