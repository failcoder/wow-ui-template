...
local _hook_AddonsList_Update = function()
	for i = 1, MAX_ADDONS_DISPLAYED do
		UI.API:Set("CheckButton", _G["AddonListEntry"..i.."Enabled"])
		UI.API:Set("Button", _G["AddonListEntry"..i.."Load"])
	end
end
--[[
##########################################################
...
local function SystemPanelQue()
	if UI.db.Skins.blizzard.enable ~= true or UI.db.Skins.blizzard.misc ~= true then return end
	...
	local CAPS_TEXT_FONT = LibStub("LibSharedMedia-3.0"):Fetch("font", UI.Media.font.caps.file);
  	local caps_fontsize = UI.Media.font.caps.size;
	...
	do
		...
		GhostFrame:SetPoint("CENTER", CUSTOM_UI_SpecialAbility, "CENTER", 0, 0)
	...
	if(AddonList) then
		...
		UI.API:Set("Window", AddonList, true, true)
		UI.API:Set("Button", AddonListEnableAllButton)
		UI.API:Set("Button", AddonListDisableAllButton)
		UI.API:Set("Button", AddonListDisableAllButton)
		UI.API:Set("Button", AddonListCancelButton)
		UI.API:Set("Button", AddonListOkayButton)
		UI.API:Set("CheckButton", AddonListForceLoad)
		UI.API:Set("DropDown", AddonCharacterDropDown)
		UI.API:Set("ScrollBar", AddonListScrollFrameScrollBar)
		for i = 1, MAX_ADDONS_DISPLAYED do
			UI.API:Set("CheckButton", _G["AddonListEntry"..i.."Enabled"])
			UI.API:Set("Button", _G["AddonListEntry"..i.."Load"])
		end
	...
	if(MacOptionsFrame) then
		...
		UI.API:Set("DropDown", MacOptionsFrameResolutionDropDown)
		UI.API:Set("DropDown", MacOptionsFrameFramerateDropDown)
		UI.API:Set("DropDown", MacOptionsFrameCodecDropDown)
		UI.API:Set("ScrollBar", MacOptionsFrameQualitySlider)
		for i = 1, 11 do
	...
	UI.API:Set("CloseButton", SideDressUpModelCloseButton)
	UI.API:Set("CloseButton", SideDressUpModelCloseButton)
end
--[[
##########################################################
