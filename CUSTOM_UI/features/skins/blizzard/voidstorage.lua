...
local function VoidStorageStyle()
  MOD.Debugging = true
  if UI.db.Skins.blizzard.enable ~= true or UI.db.Skins.blizzard.voidstorage ~= true then
     return 
  end

  UI.API:Set("Window", VoidStorageFrame, true)
  ...
  UI.API:Set("CloseButton", VoidStorageBorderFrame.CloseButton)
