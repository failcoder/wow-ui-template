...
local _PRIVATE_METHODS = {
	...
	ColorGradient = oUF_CUSTOM_UI.ColorGradient,
};
...
local function SetProxyEnv()
	...
	for i=1, 30 do
		_PRIVATE_TAGS['name:'..i] = oUF_CUSTOM_UI.Tags.Methods['name:'..i]
	end

	_PRIVATE_TAGS['name:color'] = oUF_CUSTOM_UI.Tags.Methods['name:color']
	_PRIVATE_TAGS['name:grid'] = oUF_CUSTOM_UI.Tags.Methods['name:grid']
	_PRIVATE_TAGS['health:color'] = oUF_CUSTOM_UI.Tags.Methods['health:color']
	_PRIVATE_TAGS['health:current'] = oUF_CUSTOM_UI.Tags.Methods['health:current']
	_PRIVATE_TAGS['health:deficit'] = oUF_CUSTOM_UI.Tags.Methods['health:deficit']
	_PRIVATE_TAGS['health:curpercent'] = oUF_CUSTOM_UI.Tags.Methods['health:curpercent']
	_PRIVATE_TAGS['health:curmax'] = oUF_CUSTOM_UI.Tags.Methods['health:curmax']
	_PRIVATE_TAGS['health:curmax-percent'] = oUF_CUSTOM_UI.Tags.Methods['health:curmax-percent']
	_PRIVATE_TAGS['health:max'] = oUF_CUSTOM_UI.Tags.Methods['health:max']
	_PRIVATE_TAGS['health:percent'] = oUF_CUSTOM_UI.Tags.Methods['health:percent']
	_PRIVATE_TAGS['power:color'] = oUF_CUSTOM_UI.Tags.Methods['power:color']
	_PRIVATE_TAGS['power:current'] = oUF_CUSTOM_UI.Tags.Methods['power:current']
	_PRIVATE_TAGS['power:deficit'] = oUF_CUSTOM_UI.Tags.Methods['power:deficit']
	_PRIVATE_TAGS['power:curpercent'] = oUF_CUSTOM_UI.Tags.Methods['power:curpercent']
	_PRIVATE_TAGS['power:curmax'] = oUF_CUSTOM_UI.Tags.Methods['power:curmax']
	_PRIVATE_TAGS['power:curmax-percent'] = oUF_CUSTOM_UI.Tags.Methods['power:curmax-percent']
	_PRIVATE_TAGS['power:max'] = oUF_CUSTOM_UI.Tags.Methods['power:max']
	_PRIVATE_TAGS['power:percent'] = oUF_CUSTOM_UI.Tags.Methods['power:percent']
end
...
function MOD:ViewGroupFrames(headerFrame, setForced, setAuraForced, setHighlightForced)
	...
	if setForced then
		...
		local db = UI.db.UnitFrames[raidToken]
