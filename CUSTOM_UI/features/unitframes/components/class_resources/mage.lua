...
if(UI.class ~= "MAGE") then return end 
...
local CHARGE_ICON = [[Interface\AddOns\CUSTOM_UI_UnitFrames\assets\Class\MAGE-CHARGE]];
local ICICLE_ICON = [[Interface\AddOns\CUSTOM_UI_UnitFrames\assets\Class\MAGE-ICICLE]];
local NO_ART = UI.NoTexture;
UI.SpecialFX:Register("mage_fire", [[Spells\Fill_fire_cast_01.m2]], 2, -2, -2, 2, 0.5, -0.45, 1)
...
function MOD:CreateClassBar(playerFrame)
	...
	for i = 1, max do 
		...
		UI.SpecialFX:SetFXFrame(bar[i], "arcane")
	...
	UI.SpecialFX:SetFXFrame(bgFrame, "arcane")
