...
if(UI.class ~= "MONK") then return end
...
local STAGGER_BAR = [[Interface\AddOns\CUSTOM_UI_UnitFrames\assets\Class\MONK-STAGGER-BAR]];
local STAGGER_BG = [[Interface\AddOns\CUSTOM_UI_UnitFrames\assets\Class\MONK-STAGGER-BG]];
local STAGGER_FG = [[Interface\AddOns\CUSTOM_UI_UnitFrames\assets\Class\MONK-STAGGER-FG]];
local STAGGER_ICON = [[Interface\AddOns\CUSTOM_UI_UnitFrames\assets\Class\MONK-STAGGER-ICON]];

local CHI_FILE = [[Interface\Addons\CUSTOM_UI_UnitFrames\assets\Class\MONK]];
local CHI_COORDS = {
	[1] = {0,0.5,0,0.5},
	[2] = {0.5,1,0,0.5},
	[3] = {0,0.5,0.5,1},
...
local StartFlash = function(self) UI.Animate:Flash(self.overlay,1,true) end
local StopFlash = function(self) UI.Animate:StopFlash(self.overlay) end
--[[
##########################################################
MONK HARMONY
##########################################################
...
function MOD:CreateClassBar(playerFrame)
	...
	for i=1, max do
		...
		UI.SpecialFX:SetFXFrame(bar[i], "chi")
	...
	stagger:SetStatusBarTexture(UI.Media.statusbar.default)
	...
	stagger.bg:SetTexture(UI.Media.statusbar.default)
