...
local TEXT_FORMATTING = function(tanks, heals, dps)
	local result = ""
	if tanks then
		result = result.."|TInterface\\AddOns\\CUSTOM_UI_!Core\\assets\\textures\\default\\tank.tga:14:14|t" 
	end 
	if heals then
		result = result.."|TInterface\\AddOns\\CUSTOM_UI_!Core\\assets\\textures\\default\\healer.tga:14:14|t" 
	end 
	if dps then
		result = result.."|TInterface\\AddOns\\CUSTOM_UI_!Core\\assets\\textures\\default\\dps.tga:14:14|t" 
	end 
	return result 
end
