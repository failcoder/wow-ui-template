...
UI.SystemAlert.SET_BN_BROADCAST={
...
local menuFrame = CreateFrame("Frame", "FriendDatatextRightClickMenu", UI.Screen, "UIDropDownMenuTemplate")
local menuList = {
	...
	{ text = BN_BROADCAST_TOOLTIP, notCheckable = true, func = function() UI:StaticPopup_Show("SET_BN_BROADCAST") end },
}
