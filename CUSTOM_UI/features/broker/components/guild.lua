...
local GuildDatatTextRightClickMenu = CreateFrame("Frame", "GuildDatatTextRightClickMenu", UI.Screen, "UIDropDownMenuTemplate")
...
local GuildStatEventHandler = {
	...
	["CUSTOM_UI_FORCE_RUN"] = UI.fubar,
	["CUSTOM_UI_COLOR_UPDATE"] = UI.fubar
};
