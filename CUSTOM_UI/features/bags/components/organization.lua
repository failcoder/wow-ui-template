...
function MOD:InitializeMenus()
	-- BagFilters:SetParent(UI.Screen)
	...
	for i = LE_BAG_FILTER_FLAG_EQUIPMENT, NUM_LE_BAG_FILTER_FLAGS do
		...
		BagFilters.buttons[i].hoverTex:SetTexture([[Interface\AddOns\CUSTOM_UI\media\textures\TITLE-HIGHLIGHT]])
		...
		BagFilters.buttons[i].activeTex:SetTexture([[Interface\AddOns\CUSTOM_UI\media\textures\TITLE-HIGHLIGHT]])
		...
		BagFilters.buttons[i].text:SetFont(UI.Media.font.default,12,"OUTLINE")
	...
	BagFilters.buttons[clearID].hoverTex:SetTexture([[Interface\AddOns\CUSTOM_UI\media\textures\TITLE-HIGHLIGHT]])
	...
	BagFilters.buttons[clearID].text:SetFont(UI.Media.font.default,12,"OUTLINE")
	...
	BagFilters:Hide()
	UI:ManageVisibility(BagFilters)
end
--[[
##########################################################
BAG EVENTS
...
local Container_OnEvent = function(self, event, ...)
	...
	elseif(event == "PLAYERREAGENTBANKSLOTS_CHANGED") then
		local slotID = ...
		local container = _G["CUSTOM_UI_ReagentContainerFrame"]
