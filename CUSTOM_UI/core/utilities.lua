...
do
    ...
    function UI:GetReversePoint(point)
        return _inverted[point];
    end

    function UI:SetReversePoint(frame, point, target, x, y)
...
function UI:AnchorToCursor(frame)
...
function UI:ParseSeconds(seconds)
    local negative = ""
...
function UI:SetFrameVisibilityLocks(frame)
