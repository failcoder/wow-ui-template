...
local lib = Librarian:NewLibrary("Media");
...
lib.DialogFontDefault = "CUSTOM_UI Dialog Font";
if(GetLocale() ~= "enUS") then
	lib.DialogFontDefault = "CUSTOM_UI Default Font";
end
lib.BaseTexture 	= [[Interface\AddOns\CUSTOM_UI\media\backgrounds\DEFAULT]];
lib.NoTexture 	  = [[Interface\AddOns\CUSTOM_UI\media\EMPTY]];
--[[
##########################################################
CORE FUNCTIONS
##########################################################
...
function lib:HexColor(arg1,arg2,arg3)
	local r,g,b;
...
function lib:FontManager(obj, template, arg, sizeMod, styleOverride, colorR, colorG, colorB)
