...
MOD.Media = {}
MOD.Media.microMenuFile = [[Interface\AddOns\CUSTOM_UI_ActionBars\assets\MICROMENU]];
...
UI.defaults[Schema] = {
	...
	["fontSize"] = 11,  
	["fontOutline"] = "OUTLINE",
	["countFont"] = "CUSTOM_UI Number Font", 
	["countFontSize"] = 11,  
...
function MOD:LoadOptions()
	local count = UI.db.ActionBars.barCount or 6
	...
	UI.Options.args.primary.args.quickGroup1.args.toggleKeybind = {
		order = 5, 
		width = "full", 
		type = "execute", 
		name = L["Keybind Mode"], 
	...
	UI.Options.args[Schema] = {
		...
		args = {
			barCount = {
				...
				max = 10, 
				step = 1,
				get = function(e)return UI.db[Schema][e[#e]]end, 
				set = function(e, f)UI.db[Schema][e[#e]] = f;UI:StaticPopup_Show("RL_CLIENT")end
			},
			barGroup = {
				order = 3, 
				type = "group", 
				...
				args = {
					commonGroup = {
						...
						args = {
							...
							unc = {
								...
								hasAlpha = true, 
								get = function(key) return unpack(UI.db[Schema][key[#key]]) end, 
								set = function(key, rValue, gValue, bValue, aValue)
									UI.db[Schema][key[#key]][1] = rValue
									UI.db[Schema][key[#key]][2] = gValue
									UI.db[Schema][key[#key]][3] = bValue
									UI.db[Schema][key[#key]][4] = aValue
									MOD:RefreshActionBars()
								end, 
							}, 
							unpc = {
					...
					Pet = {
						...
						type = "group",
						guiInline = false,
						get = function(e)return UI.db[Schema]["Pet"][e[#e]]end,
						set = function(key, value)
						...
						args = {
							...
							backdrop = {
								...
								name = L["Background"],
								type = "toggle",
								disabled = function()return not UI.db[Schema]["Pet"].enable end,
							},
							mouseover = {
								order = 3,
								name = L["Mouse Over"],
							...
							restorePosition = {
								...
								func = function()
									UI:ResetData("ActionBars", "Pet")
									UI:ResetAnchors("Pet Bar")
									MOD:RefreshBar("Pet")
								end,
								disabled = function()return not UI.db[Schema]["Pet"].enable end,
							},
							...
							customGroup = {
								...
								args = {
									useCustomVisibility = {
										...
										get = function()return UI.db[Schema]["Pet"].useCustomVisibility end,
										set = function(e,f)
											UI.db[Schema]["Pet"].useCustomVisibility = f;
											MOD:RefreshBar("Pet")
										end
									},
									resetVisibility = {
										...
										func = function()
											UI:ResetData("ActionBars", "Pet", "customVisibility")
											MOD:RefreshBar("Pet")
										end
									},
									customVisibility = {
										...
										get = function(e)return UI.db[Schema]["Pet"].customVisibility end,
										set = function(e,f)
											UI.db[Schema]["Pet"].customVisibility = f;
											MOD:RefreshBar("Pet")
										end,
										disabled = function()return not UI.db[Schema]["Pet"].useCustomVisibility end,
									},
								}
							}
						}
					...
					Stance = {
						...
						type = "group",
						guiInline = false,
						get = function(e)return UI.db[Schema]["Stance"][e[#e]]end,
						set = function(key, value)
						...
						args = {
							...
							backdrop = {
								...
								name = L["Background"],
								type = "toggle",
								disabled = function()return not UI.db[Schema]["Stance"].enable end,
							},
							mouseover = {
								order = 3,
								name = L["Mouse Over"],
							...
							restorePosition = {
								...
								desc = L["Restore the actionbars default settings"],
								func = function()
									UI_Registry:SetDefault("ActionBars","Stance")
									UI:ResetAnchors("Stance Bar")
									MOD:RefreshBar("Stance")
								end,
								disabled = function()return not UI.db[Schema]["Stance"].enable end,
							},
							...
							customGroup = {
								...
								args = {
									...
									useCustomVisibility = {
										...
										name = L["Enable"],
										desc = L["Allow the use of custom paging for this bar"],
										get = function()return UI.db[Schema]["Stance"].useCustomVisibility end,
										set = function(e,f)
											UI.db[Schema]["Stance"].useCustomVisibility = f;
											MOD:RefreshBar("Stance")
										end
									},
									resetVisibility = {
										...
										desc = L["Restore default visibility attributes for this bar"],
										func = function()
											UI:ResetData("ActionBars", "Stance", "customVisibility")
											MOD:RefreshBar("Stance")
										end
									},
									customVisibility = {
										...
										name = L["Visibility"],
										desc = L["|cffFF0000ADVANCED:|r Set the visibility attributes for this bar"],
										get = function(e)return UI.db[Schema]["Stance"].customVisibility end,
										set = function(e,f)
											UI.db[Schema]["Stance"].customVisibility = f;
											MOD:RefreshBar("Stance")
										end,
										disabled = function()return not UI.db[Schema]["Stance"].useCustomVisibility end,
									},
								}
							}
						}
					...
					Totem = {
						...
						guiInline = false,
						get = function(key) 
							return UI.db[Schema]["Totem"][key[#key]] 
						end, 
						set = function(key, value)
						...
						args = {
							...
							buttonsize = {
								...
								max = 60,
								step = 1,
								disabled = function()return not UI.db[Schema]["Totem"].enable end,
							},
							buttonspacing = {
								order = 3,
								type = "range",
					...
					Micro = {
						...
						get = function(key) 
							return UI.db[Schema]["Micro"][key[#key]] 
						end, 
						set = function(key, value)
						...
						args = {
							...
							mouseover = {
								...
								name = L["Mouse Over"],
								desc = L["The frame is not shown unless you mouse over the frame."],
								disabled = function()return not UI.db[Schema]["Micro"].enable end,
								type = "toggle"
							},
							buttonsize = {
								order = 3,
	...
	for barNumber = 1, count do 
		...
		UI.Options.args[Schema].args.barGroup.args[barKey] = {
			order = (barNumber + 1),
			name = L["Bar"] .. " " .. barNumber, 
			type = "group", 
			guiInline = false, 
			get = function(key) 
				return UI.db[Schema][barKey][key[#key]] 
			end, 
			set = function(key, value)
			...
			args = {
				...
				backdrop = {
					...
					name = L["Background"], 
					type = "toggle", 
					disabled = function()return not UI.db[Schema][barKey].enable end, 
				}, 
				mouseover = {
					order = 3, 
					name = L["Mouse Over"], 
				...
				restorePosition = {
					...
					desc = L["Restore the actionbars default settings"], 
					func = function()
						UI:ResetData("ActionBars", barKey)
						UI:ResetAnchors(barKey)
						MOD:RefreshBar(barKey)
					end, 
					disabled = function()return not UI.db[Schema][barKey].enable end, 
				}, 
				...
				pagingGroup = {
					...
					args = {
						useCustomPaging = {
							...
							name = L["Enable"], 
							desc = L["Allow the use of custom paging for this bar"], 
							get = function()return UI.db[Schema][barKey].useCustomPaging end, 
							set = function(e, f)
								UI.db[Schema][barKey].useCustomPaging = f;
						...
						resetStates = {
							...
							func = function()
								UI:ResetData("ActionBars", barKey, "customPaging")
								MOD:UpdateBarPagingDefaults();
								MOD:RefreshBar(barKey)
							end
						}, 
						customPaging = {
							...
							get = function(e)return UI.db[Schema][barKey].customPaging[UI.class] end, 
							set = function(e, f)
								UI.db[Schema][barKey].customPaging[UI.class] = f;
								MOD:UpdateBarPagingDefaults();
								MOD:RefreshBar(barKey)
							end, 
							disabled = function()return not UI.db[Schema][barKey].useCustomPaging end, 
						}, 
						useCustomVisibility = {
							order = 4, 
							type = "toggle", 
							name = L["Enable"], 
							desc = L["Allow the use of custom paging for this bar"], 
							get = function()return UI.db[Schema][barKey].useCustomVisibility end, 
							set = function(e, f)
								UI.db[Schema][barKey].useCustomVisibility = f;
								MOD:UpdateBarPagingDefaults();
								MOD:RefreshBar(barKey)
							end
						}, 
						resetVisibility = {
							...
							desc = L["Restore default visibility attributes for this bar"], 
							func = function()
								--UI:ResetData("ActionBars", barKey, "customVisibility")
								UI.db[Schema][barKey].customVisibility = UI.defaults[Schema][barKey].customVisibility;
								MOD:UpdateBarPagingDefaults();
								MOD:RefreshBar(barKey)
							end
						}, 
						customVisibility = {
							...
							name = L["Visibility"], 
							desc = L["|cffFF0000ADVANCED:|r Set the visibility attributes for this bar"], 
							get = function(e)return UI.db[Schema][barKey].customVisibility end, 
							set = function(e, f)
								UI.db[Schema][barKey].customVisibility = f;
								MOD:UpdateBarPagingDefaults();
								MOD:RefreshBar(barKey)
							end, 
							disabled = function()return not UI.db[Schema][barKey].useCustomVisibility end, 
						}, 
