...
L["BAGS_DESC"] = "CUSTOM_UI 위해 가방 설정을 조정합니다."
L["CHAT_DESC"] = "CUSTOM_UI의 대화창을 설정합니다."
L["STATS_DESC"] = "Configure docked stat panels.";
L["CUSTOM_UI_DESC"] = "CUSTOM_UI는 WoW의 애드온을 대신하는 완전한 애드온입니다."
...
L["Gloom & Doom"]=true;
L["Disable"]=true;
L["CUSTOM_UI Installation"]="CUSTOM_UI 설치"
L["Finished"]="마침"
L["Grid Size:"]="격자 크기 :"
L["Healer"]="힐러"
...
L["Please click the button below to setup your CVars."]="CUSTOM_UI의 게임 인터페이스 설정(CVars)을 설치하려면 아래 버튼을 클릭하세요."
L["Please press the continue button to go onto the next step."]="다음 단계로 가시려면 계속 버튼을 누르세요."
L["Resolution Style Set"]="해상도 스타일 설정"
L["Resolution"]="해상도"
L["Select the type of aura system you want to use with CUSTOM_UI's unitframes. The integrated system utilizes both aura-bars and aura-icons. The icons only system will display only icons and aurabars won't be used. The classic system will configure your auras to be default."]=true;
L["Setup Chat"]="대화창 설치"
L["Setup CVars"]="저장된 대화창 설정 설치"
L["Skip Process"]="건너뛰기"
L["Sticky Frames"]="달라붙는 프레임"
L["Tank"]="방어전담"
L["The chat windows function the same as Blizzard standard chat windows, you can right click the tabs and drag them around, rename, etc. Please click the button below to setup your chat windows."]="CUSTOM_UI의 대화창은 기본 대화창과 유사합니다. 대화탭을 우클릭하거나 드래그해서 이동하거나 이름을 바꿀 수 있습니다.\n 아래 버튼을 클릭하여 대화창을 설치하세요."
...
L["Theme Set"]=true;
L["Theme Setup"]=true;
L["This install process will help you learn some of the features in CUSTOM_UI has to offer and also prepare your user interface for usage."]="이 설치과정은 UI의 사용에 대한 준비를 제공함과 동시에 몇가지의 구성요소에 대해 배울 수 있습니다."
...
L["Welcome to CUSTOM_UI version %s!"]="CUSTOM_UI 버전 %s에 오신 것을 환영합니다!"
...
L["Your version of CUSTOM_UI is out of date. You can download the latest version from http://www.wowinterface.com"]="당신의 CUSTOM_UI 버전이 구버전입니다. 당신은 http://www.wowinterface.com에서 최신 버전을 다운로드하실 수 있습니다."
...
L["You have changed your UIScale, however you still have the AutoScale option enable in UI. Press accept if you would like to disable the Auto Scale option."]="UI 배율이 변경되었지만 CUSTOM_UI의 자동크기 설정이 켜져있습니다. 자동크기 설정을 끄고 싶다면 '수락'을 누르세요."
L["You must purchase a bank slot first!"]="우선 은행가방 칸을 구입해야됩니다!"
L["Count"]="갯수"
L["Targeted By:"]="선택:"
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under CUSTOM_UI and setting a keybind for the raid marker."]=true;
L["CUSTOM_UI has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."]=true;
...
L["If you are experiencing issues with CUSTOM_UI try disabling all your addons except CUSTOM_UI, remember CUSTOM_UI is a full UI replacement addon, you cannot run two addons that do the same thing."]=true;
L["The buff panel to the right of minimap is a list of your consolidated buffs. You can disable it in Buffs and Debuffs options of UI."]=true;
