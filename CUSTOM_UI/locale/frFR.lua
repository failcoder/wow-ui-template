...
L["Hearthstone"] = true;
--[[LOGIN MESSAGE]]--
L["LOGIN_MSG"] = "Bienvenue sur |cffFFFF1ACUSTOM_UI|r! Gardez votre %s et votre %s."
...
L["BAGS_DESC"] = "Ajuster les paramètres des sacs pour UI."
L["CHAT_DESC"] = "Ajuste les paramètres du Chat pour UI."
L["STATS_DESC"] = "Configure docked stat panels.";
L["CUSTOM_UI_DESC"] = "CUSTOM_UI est une interface de remplacement complète pour World of Warcraft"
...
L["TOGGLEART_DESC"] = "Active ou désactive l'habillage CUSTOM_UI des éléments ci-dessous."
...
L["CUSTOM_UI_DockBottomCenter"] = "Bottom Data Dock"
L["CUSTOM_UI_DockTopCenter"] = "Top Data Dock"
--[[REACTION TEXTS]]--
L[" is drinking."] = true;
L["Leeeeeroy!"] = true;
...
L["This is CUSTOM_UI version %s!"] = true;
...
L["You can always change fonts and colors of any element of CUSTOM_UI from the in-game configuration."] = true;
...
L["Big X2"] = true;
L["Auras System"] = true;
L["Select the type of aura system you want to use with CUSTOM_UI's unitframes. The Icon Lovers set will display only icons and aurabars won't be used. The Vintage set will use the original game style and the Gimme Everything set does just what it says.... icons, bars and awesomeness."] = true;
...
L["CUSTOM_UI Installation"]="Installation d'CUSTOM_UI"
L["Finished"]="Terminé"
...
L["Select the type of aura system you want to use with CUSTOM_UI's unitframes. The integrated system utilizes both aura-bars and aura-icons. The icons only system will display only icons and aurabars won't be used. The classic system will configure your auras to be default."]="Sélectionnez le type de système aura que vous souhaitez utiliser avec UnitFrames UI. Le système intégré utilise à la fois les barres d'Auras et les icônes d'Auras. Le systeme icône seul va afficher uniquement les icônes et barres d'auras ne sera pas utilisé. Le système classique permet de configurer vos Auras par défaut."
...
L["Tank"]="Tank"
L["The chat windows function the same as Blizzard standard chat windows, you can right click the tabs and drag them around, rename, etc. Please click the button below to setup your chat windows."]="La fenêtre de chat d'UIUi utilise les même fonctions que celle Blizzard, vous pouvez faire un clic droit sur un onglet pour le déplacer, le renommer, etc."
...
L["This install process will help you learn some of the features in CUSTOM_UI has to offer and also prepare your user interface for usage."]="Ce programme d'installation vous aidera à découvrir quelques fonctionnalités qu'CUSTOM_UI offre et préparera également votre interface à son utilisation."
...
L["Welcome to CUSTOM_UI version %s!"]="Bienvenue sur la version %s d'CUSTOM_UI!"
...
L["You can always change fonts and colors of any element of CUSTOM_UI from the in-game configuration."]="Vous pouvez toujours modifier les polices et les couleurs de n'importe quel élément d'CUSTOM_UI dans la configuration du jeu."
...
L["Your version of CUSTOM_UI is out of date. You can download the latest version from http://www.wowinterface.com"]="Votre version d'CUSTOM_UI n'est pas à jour. Vous pouvez télécharger la dernière version sur http://www.wowinterface.com"
...
L["Oh lord, you have got CUSTOM_UI and Tukui both enable at the same time. Select an addon to disable."]="Oh seigneur, vous avez CUSTOM_UI et Tukui d'activé en même temps. Selectionnez un add-on à désactiver."
...
L["You have changed your UIScale, however you still have the AutoScale option enable in UI. Press accept if you would like to disable the Auto Scale option."]="Vous venez de changer l'échelle de votre interface, alors que votre option d'échelle automatique est encore activée dans UI. Cliquer sur accepter si vous voulez désactiver l'option d'échelle automatique."
L["You must purchase a bank slot first!"]="Vous devez d'abord acheter un emplacement de banque !"
L["Count"]="Nombre:"
L["Targeted By:"]="Ciblé par:"
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under CUSTOM_UI and setting a keybind for the raid marker."]="Une fonction marqueur de raid est disponible en appuyant sur Echap -> Raccourcis, défilez en bas d'CUSTOM_UI et paramétrez le raccourcis pour le marqueur de raid."
L["CUSTOM_UI has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."]="CUSTOM_UI dispose d'une fonction double spécialisation qui vous permet de charger à la volée des profils différents en fonction de votre specialisation actuelle."
...
L["If you accidently remove a chat frame you can always go the in-game configuration menu, press install, go to the chat portion and reset them."]="Si vous supprimez accidentellement un cadre de discussion, vous pouvez toujours aller dans le menu de configuration d'UI. Cliquez ensuite sur Installation puis passez à l'étape concernant les fenêtres de discussion pour remettre à zero les paramètres."
L["If you are experiencing issues with CUSTOM_UI try disabling all your addons except CUSTOM_UI, remember CUSTOM_UI is a full UI replacement addon, you cannot run two addons that do the same thing."]="Si vous rencontrez des problèmes avec CUSTOM_UI, essayez de désactiver tous vos addons sauf UI. Rappelez-vous que'UIUi est une interface utilisateur complète et que vous ne pouvez pas exécuter deux addons qui font la même chose."
L["The buff panel to the right of minimap is a list of your consolidated buffs. You can disable it in Buffs and Debuffs options of UI."]="Le panneau d'améliorations à droite de la minicarte est une liste de vos améliorations groupées. Vous pouvez la désactiver dans la section Améliorations et Affaiblissement d'UI."
...
L["ENH_LOGIN_MSG"]="Vous utilisez |cff1784d1CUSTOM_UI Enhanced|r version %s%s|r."
L["Your version of CUSTOM_UI is to old. Please, download the latest version from http://www.wowinterface.com."]=true;
...
L["Customize the minimap buttons in CUSTOM_UI style."]="Habillez les boutons de la minicarte avec le style UI."
L["CUSTOM_UI Style"]="CUSTOM_UI Style"
