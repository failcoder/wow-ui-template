...
L["Hearthstone"] = true;
--[[LOGIN MESSAGE]]--
L["LOGIN_MSG"] = "歡迎使用 |cffFFFF1ACUSTOM_UI|r! 让您的 %s 和你 %s."
L["LOGIN_MSG2"] = "|cffAA78FF%s|r 版, 請輸入/sv 進入設定介面."
--[[OPTION MESSAGES]]--
L["AURAS_DESC"] = "小地圖旁的光環圖示設定."
L["BAGS_DESC"] = "調整 CUSTOM_UI 背包設定."
L["CHAT_DESC"] = "對話框架設定."
L["STATS_DESC"] = "Configure docked stat panels.";
L["CUSTOM_UI_DESC"] = "CUSTOM_UI 為一套功能完整, 可用來替換 WOW 原始介面的 UI 套件"
...
L["Gloom & Doom"]="黑暗"
L["Disable"]="禁用"
L["CUSTOM_UI Installation"]="安裝 CUSTOM_UI"
L["Finished"]="設定完畢"
L["Grid Size:"]="網格尺寸："
L["Healer"]="補師"
...
L["Theme Set"]="主題設置"
L["Theme Setup"]="主題安裝"
L["This install process will help you learn some of the features in CUSTOM_UI has to offer and also prepare your user interface for usage."]="此安裝程序有助你瞭解CUSTOM_UI 部份功能, 並可協助你預先設定UI."
...
L["Welcome to CUSTOM_UI version %s!"]="歡迎使用 CUSTOM_UI %s 版！"
L["You are now finished with the installation process. If you are in need of technical support please visit us at http://www.wowinterface.com."]="已完成安裝程序. 小提示: ���想開啟微型選單, 請在小地圖按滑鼠中鍵. 如果沒有中鍵按鈕, 請按住Shift鍵, 並在小地圖按滑鼠右鍵. 如需技術支援請至http://www.wowinterface.com"
L["You can always change fonts and colors of any element of CUSTOM_UI from the in-game configuration."]="你可以在遊戲內的設定選項內更改CUSTOM_UI的字體、顏色等設定."
...
L["Your version of CUSTOM_UI is out of date. You can download the latest version from http://www.wowinterface.com"]="CUSTOM_UI 版本已過期, 請至http://www.wowinterface.com 下載最新版"
...
L["I Swear"]='我承諾'
L["Oh lord, you have got CUSTOM_UI and Tukui both enable at the same time. Select an addon to disable."]="你不能同時啓用CUSTOM_UI和Tukui， 請選擇一個禁用."
...
L["You have changed your UIScale, however you still have the AutoScale option enable in UI. Press accept if you would like to disable the Auto Scale option."]="你改變了介面縮放比例, 然而CUSTOM_UI的自動縮放選項是開啟的. 點擊接受以關閉CUSTOM_UI的自動縮放."
L["You must purchase a bank slot first!"]="你必需購買一個銀行背包欄位!"
L["Count"]="計數"
L["Targeted By:"]="同目標的有:"
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under CUSTOM_UI and setting a keybind for the raid marker."]="你可以通過按ESC鍵-> 按鍵設定, 滾動到CUSTOM_UI設定下方設定一個快速標記的快捷鍵."
L["CUSTOM_UI has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."]="CUSTOM_UI可以根據你所使用的天賦自動套用不同的設定檔. 你可以在配置文件中使用此功能."
...
L["If you are experiencing issues with CUSTOM_UI try disabling all your addons except CUSTOM_UI, remember CUSTOM_UI is a full UI replacement addon, you cannot run two addons that do the same thing."]="如果你遇到問題, CUSTOM_UI會嘗試禁用你除了CUSTOM_UI之外的插件. 請記住你不能用不同的插件實現同一功能."
L["The buff panel to the right of minimap is a list of your consolidated buffs. You can disable it in Buffs and Debuffs options of UI."]="小地圖右側的光環條是你的整合Buff條, 你可以在你的CUSTOM_UI光環設定中關閉此功能."
...
L["Ghost"]="鬼魂"
L["Offline"]="離線"
L["ENH_LOGIN_MSG"]="您正在使用 |cff1784d1CUSTOM_UI Enhanced|r version %s%s|r."
L["Your version of CUSTOM_UI is to old. Please, download the latest version from http://www.wowinterface.com."]="您的CUSTOM_UI版本過低(需要 v6.51 或更高), 請前往http://www.wowinterface.com下載最新版本."
L["Equipment"]="自動換裝"
...
L["Customize the minimap buttons in CUSTOM_UI style."]="將小地圖圖標美化成CUSTOM_UI風格."
L["CUSTOM_UI Style"]="美化風格"
