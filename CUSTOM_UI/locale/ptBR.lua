...
L["Hearthstone"] = true;
--[[LOGIN MESSAGE]]--
L["LOGIN_MSG"] = "Bem vindo à |cffFFFF1ACUSTOM_UI|r! Manter o seu %s e seu %s."
...
L["BAGS_DESC"] = "Ajustar definições das bolsas para a UI."
L["CHAT_DESC"] = "Adjustar definições do bate-papo para o UI."
L["STATS_DESC"] = "Configure docked stat panels.";
L["CUSTOM_UI_DESC"] = "A CUSTOM_UI é um Addon completo de substituição da interface original do World of Warcraft."
...
L["Gloom & Doom"]="Escuro"
L["Disable"]="Desativar"
L["CUSTOM_UI Installation"]="Instalação do CUSTOM_UI"
...
L["This install process will help you learn some of the features in CUSTOM_UI has to offer and also prepare your user interface for usage."]="Este processo de instalação vai mostrar-lhe algumas das opções que a CUSTOM_UI tem para oferecer e também vai preparar a sua interface para ser usada."
...
L["Welcome to CUSTOM_UI version %s!"]="Bem-vindo à versão %s da CUSTOM_UI!"
...
L["You can always change fonts and colors of any element of CUSTOM_UI from the in-game configuration."]="As cores e fontes da CUSTOM_UI podem ser mudadas em qualquer momento no modo de configuração demtro do jogo."
...
L["Your version of CUSTOM_UI is out of date. You can download the latest version from http://www.wowinterface.com"]="A sua versão da CUSTOM_UI está desatualizada. Pode baixar a versão mais recente no site http://www.wowinterface.com."
...
L["I Swear"]="Eu Juro"
L["Oh lord, you have got CUSTOM_UI and Tukui both enable at the same time. Select an addon to disable."]="Oh senhor, você está com os addons CUSTOM_UI e Tuki ativos ao mesmo tempo. Selecione um para desativar."
...
L["If you are experiencing issues with CUSTOM_UI try disabling all your addons except CUSTOM_UI, remember CUSTOM_UI is a full UI replacement addon, you cannot run two addons that do the same thing."]="Se estiver a ter problemas com a CUSTOM_UI tente desativar todos os addons exceto a CUSTOM_UI, lembre-se que a CUSTOM_UI é um addon de substituição de interface completo, e não se consegue executar dois addons que fazem a mesma coisa."
L["The buff panel to the right of minimap is a list of your consolidated buffs. You can disable it in Buffs and Debuffs options of UI."]="O painel de bônus a direita do minimapa é uma lista dos seus bônus consolidados. Você pode desativar isto nas opções de Bônus e Penalidades da UI."
...
L["ENH_LOGIN_MSG"]="Você está a usar |cff1784d1CUSTOM_UI Enhanced|r versão %s%s|r."
L["Your version of CUSTOM_UI is to old. Please, download the latest version from http://www.wowinterface.com."]="A sua versão do CUSTOM_UI é muita antiga (requerida v6.51 ou superior). Por favor, descarregue a versão mais recente em http://www.wowinterface.com."
...
L["Customize the minimap buttons in CUSTOM_UI style."]="Customiza os botões do minimapa no estilo do UI."
L["CUSTOM_UI Style"]="Estilo de Customização"
