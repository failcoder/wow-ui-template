...
L["Hearthstone"] = true;
--[[LOGIN MESSAGE]]--
L["LOGIN_MSG"] = "обро пожаловать в |cffFFFF1ACUSTOM_UI|r! Держите свои %s и ваши %s."
...
L["BAGS_DESC"] = "Настройки сумок CUSTOM_UI"
L["CHAT_DESC"] = "Настройте отображение чата UI."
L["STATS_DESC"] = "Configure docked stat panels.";
L["CUSTOM_UI_DESC"] = "CUSTOM_UI это аддон для полной замены пользовательского интерфейса World of Warcraft."
...
L["Gloom & Doom"]="Темная"
L["Disable"]="Выключить"
L["CUSTOM_UI Installation"]="Установка CUSTOM_UI"
...
L["Please click the button below to setup your CVars."]="Пожалуй��та, нажмите кнопку ниже для сброса настроек."
...
L["Theme Setup"]="Тема"
L["This install process will help you learn some of the features in CUSTOM_UI has to offer and also prepare your user interface for usage."]="Этот процесс установки поможет Вам узнать о некоторых функциях CUSTOM_UI и подготовить Ваш интерфейс к использованию."
...
L["Welcome to CUSTOM_UI version %s!"]="Добро пожаловать в CUSTOM_UI версии %s!"
...
L["You can always change fonts and colors of any element of CUSTOM_UI from the in-game configuration."]="Вы всегда можете изменить шрифты и цвета любого элемента CUSTOM_UI из меню конфигурации. Классическая и пиксельная темы не отличаются для русского клиента."
...
L["Your version of CUSTOM_UI is out of date. You can download the latest version from http://www.wowinterface.com"]="Ваша версия CUSTOM_UI устарела. Вы можете скачать последнюю версию на http://www.wowinterface.com"
...
L["I Swear"]="Я клянусь!"
L["Oh lord, you have got CUSTOM_UI and Tukui both enable at the same time. Select an addon to disable."]="Японский городовой... у Вас одновременно включены UIUi и Tukui. Выюерите аддон для отключения."
...
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under CUSTOM_UI and setting a keybind for the raid marker."]='Функция рейдовых меток доступна в Escape -> Назначение клавиш. Прокрутите вниз до раздела CUSTOM_UI и назначьте клавишу для рейдовых меток.'
L["CUSTOM_UI has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."]='В CUSTOM_UI присутствует функция двойной специализации, которая позволит Вам использовать разные профили для разных наборов талантов. Вы можете включить эту функцию в разделе профилей.'
...
L["If you are experiencing issues with CUSTOM_UI try disabling all your addons except CUSTOM_UI, remember CUSTOM_UI is a full UI replacement addon, you cannot run two addons that do the same thing."]='Если Вы испытываете проблемы с CUSTOM_UI, попробуйте отключить все аддоны, кроме самого UI. Помните, CUSTOM_UI это аддон, полностью заменяющий интерфейс, Вы не можете одновременно использовать два аддона, выполняющих одинаковые функции.'
L["The buff panel to the right of minimap is a list of your consolidated buffs. You can disable it in Buffs and Debuffs options of UI."]='Панель с баффами справа от миникарты это список Ваших объединенных баффов. Вы можете отключить ее в разделе эффектов и аур в настр��йках UI.'
