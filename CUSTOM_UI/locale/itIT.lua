...
L["Hearthstone"] = true;
--[[LOGIN MESSAGE]]--
L["LOGIN_MSG"] = "Benvenuti a |cffFFFF1ACUSTOM_UI|r! Mantenete il vostro %s e il vostro %s."
...
L["BAGS_DESC"] = "Adjust bag settings for UI."
L["CHAT_DESC"] = "Adjust chat settings for UI."
L["STATS_DESC"] = "Configure docked stat panels.";
L["CUSTOM_UI_DESC"] = "CUSTOM_UI is a complete User Interface replacement addon for World of Warcraft."
...
L["Theme Set"]=true;
L["Theme Setup"]=true;
L["This install process will help you learn some of the features in CUSTOM_UI has to offer and also prepare your user interface for usage."]=true;
L["This is completely optional."]=true;
...
L["Welcome to CUSTOM_UI version %s!"]=true;
...
L["Your version of CUSTOM_UI is out of date. You can download the latest version from http://www.wowinterface.com"]=true;
...
L["You have changed your UIScale, however you still have the AutoScale option enable in UI. Press accept if you would like to disable the Auto Scale option."]=true;
