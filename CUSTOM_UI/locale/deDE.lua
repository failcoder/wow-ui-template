...
--[[LOGIN MESSAGE]]--
L["LOGIN_MSG"] = "Willkommen zu |cffFFFF1ACUSTOM_UI|r! halten Sie Ihre %s und Ihre %s."
...
L["CHAT_DESC"] = "Anpassen der Chateinstellungen für UI."
L["STATS_DESC"] = "Configure docked stat panels.";
L["CUSTOM_UI_DESC"] = "CUSTOM_UI ist ein komplettes Benutzerinterface für World of Warcraft."
...
L["CUSTOM_UI Installation"]="CUSTOM_UI Installation"
L["Finished"]="Beendet"
...
L["The in-game configuration menu can be accesses by typing the /sv command or by clicking the 'C' button on the minimap. Press the button below if you wish to skip the installation process."]="Das CUSTOM_UI-Konfigurationsmenü kannst du entweder mit /sv oder durch das Anklicken der 'C' Taste an der Minimap aufrufen. Drücke 'Schritt überspringen' um zum nächsten Schritt zu gelangen."
...
L["This install process will help you learn some of the features in CUSTOM_UI has to offer and also prepare your user interface for usage."]="Dieser Installationsprozess wird dir helfen, die Funktionen von CUSTOM_UI für deine Benutzeroberfläche besser kennenzulernen."
...
L["Welcome to CUSTOM_UI version %s!"]="Willkommen bei CUSTOM_UI Version %s!"
...
L["You can always change fonts and colors of any element of CUSTOM_UI from the in-game configuration."]='Du kannst jederzeit in der Ingame-Konfiguration Schriften und Farben von jedem Element des Interfaces ändern.'
...
L["Your version of CUSTOM_UI is out of date. You can download the latest version from http://www.wowinterface.com"]="Deine Version von CUSTOM_UI ist veraltet. Du kannst die aktuelle Version von http://www.wowinterface.com laden"
...
L["Oh lord, you have got CUSTOM_UI and Tukui both enable at the same time. Select an addon to disable."]=true;
...
L["If you are experiencing issues with CUSTOM_UI try disabling all your addons except CUSTOM_UI, remember CUSTOM_UI is a full UI replacement addon, you cannot run two addons that do the same thing."]='Wenn du Probleme mit CUSTOM_UI hast, deaktiviere alle Addons außer UI. Denke auch daran, dass CUSTOM_UI die komplette Benutzeroberfläche ersetzt, d.h. du kannst kein Addon verwenden, welches die gleichen Funktionen wie CUSTOM_UI nutzt.'
L["The buff panel to the right of minimap is a list of your consolidated buffs. You can disable it in Buffs and Debuffs options of UI."]='Die Stärkungszauberleiste rechts neben der Minimap ist eine Liste der zusammengefassten Stärkungszauber. Du kannst diese in den Stärkungs- und Schwachungszauber-Optionen in CUSTOM_UI deaktivieren.'
...
L["Ghost"]="Geist"
L["Offline"]="Offline"
L["ENH_LOGIN_MSG"]="Sie verwenden |cff1784d1CUSTOM_UI Enhanced|r Version %s%s|r."
L["Your version of CUSTOM_UI is to old. Please, download the latest version from http://www.wowinterface.com."]="Ihre Version von CUSTOM_UI ist zu alt (erforderlich v6.51 oder höher). Bitte laden Sie die neueste Version von http://www.wowinterface.com."
...
L["Customize the minimap buttons in CUSTOM_UI style."]='Stylene die Minimap-Buttons im CUSTOM_UI-Stil.'
L["CUSTOM_UI Style"]="Style Stil"
