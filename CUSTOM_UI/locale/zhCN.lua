...
L["BAGS_DESC"] = "调整 CUSTOM_UI 背包设置."
L["CHAT_DESC"] = "对话框架设定"
L["STATS_DESC"] = "Configure docked stat panels.";
L["CUSTOM_UI_DESC"] = "CUSTOM_UI 为一套功能完整，可用来替换 WOW 原始介面的套件"
...
L["Gloom & Doom"]="黑暗"
L["Disable"]="禁用"
L["CUSTOM_UI Installation"]="安装 CUSTOM_UI"
L["Finished"]="完成"
L["Grid Size:"]="网格尺寸:"
L["Healer"]="治疗"
...
L["Resolution"]="分辨率"
L["Select the type of aura system you want to use with CUSTOM_UI's unitframes. The integrated system utilizes both aura-bars and aura-icons. The icons only system will display only icons and aurabars won't be used."]='选择你要显示在单位框架上的光环系统, "综合"将显示图标和光环条, "图标"将只显示图标,不显示光环条.'
L["Setup Chat"]="设定对话视窗"
L["Setup CVars"]="设定参数"
L["Skip Process"]="略过"
...
L["Theme Set"]="主题设置"
L["Theme Setup"]="主题安装"
L["This install process will help you learn some of the features in CUSTOM_UI has to offer and also prepare your user interface for usage."]="此安装程序有助你了解 CUSTOM_UI 部份功能，并可协助你预先设定 UI。"
...
L["Welcome to CUSTOM_UI version %s!"]="欢迎使用 CUSTOM_UI 版本 %s!"
...
L["You can always change fonts and colors of any element of CUSTOM_UI from the in-game configuration."]="你可以在游戏内的设定选项内更改CUSTOM_UI的字体、颜色等设定."
...
L["Your version of CUSTOM_UI is out of date. You can download the latest version from http://www.wowinterface.com"]="CUSTOM_UI 版本已过期，请至 http://www.wowinterface.com 下载最新版"
...
L["I Swear"]='我承诺'
L["Oh lord, you have got CUSTOM_UI and Tukui both enable at the same time. Select an addon to disable."]="你不能同时使用CUSTOM_UI和Tukui， 请选择一个禁用."
...
L["You have changed your UIScale, however you still have the AutoScale option enable in UI. Press accept if you would like to disable the Auto Scale option."]="你改变了界面缩放比例，然而CUSTOM_UI的自动缩放选项是开启的。点击接受以关闭CUSTOM_UI的自动缩放。"
L["You must purchase a bank slot first!"]="你必需购买一个银行背包栏位"
L["Count"]="计数"
L["Targeted By:"]="同目标的有:"
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under CUSTOM_UI and setting a keybind for the raid marker."]="你可以通过按ESC键 -> 按键设置, 滚动到CUSTOM_UI设置下方设置一个快速标记的快捷键."
L["CUSTOM_UI has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."]="CUSTOM_UI可以根据你所使用的天赋自动套用不同的设置档. 你可以在配置文件中使用此功能."
...
L["If you are experiencing issues with CUSTOM_UI try disabling all your addons except CUSTOM_UI, remember CUSTOM_UI is a full UI replacement addon, you cannot run two addons that do the same thing."]="如果你遇到问题, CUSTOM_UI会尝试禁用你除了CUSTOM_UI之外的插件. 请记住你不能用不同的插件实现同一功能."
L["The buff panel to the right of minimap is a list of your consolidated buffs. You can disable it in Buffs and Debuffs options of UI."]="小地图右侧的光环条是你的整合Buff条, 你可以在你的CUSTOM_UI光环设置中关闭此功能."
...
L["You can access copy chat and chat menu functions by mouse over the top right corner of chat panel and left/right click on the button that will appear."]="你可以通过鼠标滑过对话框右上角点击���制图标打开对话复制窗口."
