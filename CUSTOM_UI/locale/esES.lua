...
L["Hearthstone"] = true;
--[[LOGIN MESSAGE]]--
L["LOGIN_MSG"] = "Bienvenido a |cffFFFF1ACUSTOM_UI|r! Mantenga su %s y su %s."
...
L["BAGS_DESC"] = "Ajusta las opciones de las bolsas para UI."
L["CHAT_DESC"] = "Configura los ajustes del chat para UI."
L["STATS_DESC"] = "Configure docked stat panels.";
L["CUSTOM_UI_DESC"] = "CUSTOM_UI es un addon que reemplaza la interfaz completa de World of Warcraft."
...
L["CUSTOM_UI Installation"]="Instalación de CUSTOM_UI"
...
L["This install process will help you learn some of the features in CUSTOM_UI has to offer and also prepare your user interface for usage."]="El proceso de instalación te ayudará a aprender algunas de las características de CUSTOM_UI y preparará la interfaz para su uso."
...
L["Welcome to CUSTOM_UI version %s!"]="Bienvenido(a) a CUSTOM_UI versión %s!"
...
L["You can always change fonts and colors of any element of CUSTOM_UI from the in-game configuration."]="Siempre puedes cambiar las fuentes y colores de cualquier elemento de CUSTOM_UI desde la configuración."
...
L["Your version of CUSTOM_UI is out of date. You can download the latest version from http://www.wowinterface.com"]="Tu versión de CUSTOM_UI no está actualizada. Puedes descargar la última versión de http://www.wowinterface.com"
...
L["I Swear"]="Lo Juro"
L["Oh lord, you have got CUSTOM_UI and Tukui both enable at the same time. Select an addon to disable."]="Oh cielos, tienes CUSTOM_UI y Tukui habilitados al mismo tiempo. Elige un addon a deshabilitar"
...
L["You have changed your UIScale, however you still have the AutoScale option enable in UI. Press accept if you would like to disable the Auto Scale option."]="Has cambiado la escala de tu interfaz, sin embargo aún tienes el AutoEscalado activado en UI. Pulsa aceptar si te gustaría desactivar el AutoEscalado."
L["You must purchase a bank slot first!"]="¡Debes comprar un hueco del banco primero!"
L["Count"]="Contador"
L["Targeted By:"]="Objetivo De:"
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under CUSTOM_UI and setting a keybind for the raid marker."]="La opción de marcador de banda está disponible pulsando Escape -> Asignar teclas -> Recorrer hacia abajo hasta CUSTOM_UI y establecer la tecla para el marcador de banda."
L["CUSTOM_UI has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."]="CUSTOM_UI tiene la posibilidad de cargar diferentes perfiles automáticamente al cambiar de especialización de talentos. Puedes activar esta función en la pestaña de perfiles."
...
L["If you are experiencing issues with CUSTOM_UI try disabling all your addons except CUSTOM_UI, remember CUSTOM_UI is a full UI replacement addon, you cannot run two addons that do the same thing."]="Si has experimentado errores con CUSTOM_UI prueba a desactivar todos tus addons excepto CUSTOM_UI, recuerda que CUSTOM_UI remplaza por completo la interfaz, no puede haber addons que hagan lo mismo."
L["The buff panel to the right of minimap is a list of your consolidated buffs. You can disable it in Buffs and Debuffs options of UI."]="El panel de beneficios a la derecha del minimapa es una lista de los beneficios consolidados. Puedes desactivarlo en la pestaña de Beneficios y Perjuicios de UI."
...
L["You can use the /resetui command to reset all of your moveables. You can also use the command to reset a specific mover, /resetui <mover name>.\nExample: /resetui Player Frame"]="Puedes usar el commando /resetui para restablecer todos tus fijadores. También puedes usar el comando para restablecer alguno en específico, /resetui <fijador>. PUI: /resetui Player Frame"
L["Ghost"]="Fantasma"
L["Offline"]="Fuera de Línea"
L["ENH_LOGIN_MSG"]="You are using |cff1784d1CUSTOM_UI Enhanced|r version %s%s|r."
...
L["Customize the minimap buttons in CUSTOM_UI style."]=true;
L["CUSTOM_UI Style"]=true;
