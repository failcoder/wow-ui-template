...
local HIGH = _G.HIGH
local LOW = _G.LOW
local scc = CUSTOM_CLASS_COLORS[UI.class];
local rcc = RAID_CLASS_COLORS[UI.class];
local r2 = .1 + (rcc.r * .1)
local g2 = .1 + (rcc.g * .1)
local b2 = .1 + (rcc.b * .1)
--[[
...
local hasOldConfigs = function()
	local installed = UI_Registry:GetSafeData("install_version")
	if(installed) then
		return USE.."\nSaved\n"..SETTINGS, "Complete"
	else
...
local ColorThemes = {
	["data"] = {
		...
		["default"] = {
			...
			["shared"] = {
				["background"] = {
					["pattern"] 	= {file = "CUSTOM_UI Backdrop 2", 	size = 0, tiled = false},
					["premium"] 	= {file = "CUSTOM_UI Artwork 2", 	size = 0, tiled = false},
					["unitlarge"] 	= {file = "CUSTOM_UI UnitBG 2", 		size = 0, tiled = false},
					["unitsmall"] 	= {file = "CUSTOM_UI SmallUnitBG 2", size = 0, tiled = false},
				}
			},
			["unitframes"] = {
		...
		["kaboom"] = {
			...
			["shared"] = {
				["background"] = {
					["pattern"] 	= {file = "CUSTOM_UI Backdrop 13", 	size = 0, tiled = false},
					["premium"] 	= {file = "CUSTOM_UI Artwork 13", 	size = 0, tiled = false},
					["unitlarge"] 	= {file = "CUSTOM_UI UnitBG 13", 		size = 0, tiled = false},
					["unitsmall"] 	= {file = "CUSTOM_UI SmallUnitBG 13", size = 0, tiled = false},
				}
			},
			["unitframes"] = {
				["buff_bars"] = {.51, .79, 0, 1},
		...
		["classy"] = {
			...
			["shared"] = {
				["background"] = {
					["pattern"] 	= {file = "CUSTOM_UI Backdrop 9", 	size = 0, tiled = false},
					["premium"] 	= {file = "CUSTOM_UI Artwork 9", 	size = 0, tiled = false},
					["unitlarge"] 	= {file = "CUSTOM_UI UnitBG 9", 		size = 0, tiled = false},
					["unitsmall"] 	= {file = "CUSTOM_UI SmallUnitBG 9", size = 0, tiled = false},
				}
			},
			["unitframes"] = {
		...
		["dark"] = {
			...
			["shared"] = {
				["background"] = {
					["pattern"] 	= {file = "CUSTOM_UI Backdrop 3", 	size = 0, tiled = false},
					["premium"] 	= {file = "CUSTOM_UI Artwork 3", 	size = 0, tiled = false},
					["unitlarge"] 	= {file = "CUSTOM_UI UnitBG 3", 		size = 0, tiled = false},
					["unitsmall"] 	= {file = "CUSTOM_UI SmallUnitBG 3", size = 0, tiled = false},
				}
			},
			["unitframes"] = {
	...
	["dialog"] = {
		...
		["Desc2"] = L["You can always change fonts and colors of any element of CUSTOM_UI from the in-game configuration."],
...
local function LoadPageData()
	PAGE_DIALOG = {
		--PAGE 1
		{
			["SubTitle"] = (L["This is CUSTOM_UI version %s!"]):format(UI.Version),
		...
		--PAGE 3
		{
			...
			["Desc1"] = (L["Your current resolution is %s, this is considered a %s resolution."]):format(GetCVar("gxResolution"), (UI.LowRez and LOW or HIGH)),
			["Desc2"] = isLowRez,
			["Desc3"] = L["CHOOSE_OR_DIE"],
...
function UI.Setup:SetAllDefaults()
	_copyPresets(UI.db, UI.defaults)
end

function UI.Setup:GenerateBackdrops()
	local BG_INDEX = math.random(1, UI.MaxBackdrops.Pattern);
	local ART_INDEX = math.random(1, UI.MaxBackdrops.Art);
	local UNIT_INDEX = math.random(1, UI.MaxBackdrops.Unit);

	local preset = {
		["pattern"] = {file = "CUSTOM_UI Backdrop "..BG_INDEX, size = 0, tiled = false},
		["premium"] = {file = "CUSTOM_UI Artwork "..ART_INDEX, size = 0, tiled = false},
		["unitlarge"] = {file = "CUSTOM_UI UnitBG "..UNIT_INDEX, size = 0, tiled = false},
		["unitsmall"] = {file = "CUSTOM_UI SmallUnitBG "..UNIT_INDEX, size = 0, tiled = false}
	}
	_copyPresets(UI.Media.shared.background, preset)
end

function UI.Setup:CopyPreset(category, theme)
...
function UI.Setup:CopyPage(pageNum)
	...
	if(PAGE_DIALOG and PAGE_DIALOG[pageNum]) then
		...
		if(req and not UI[req]) then
			return UI.Setup:CopyPage(pageNum + 1)
		else
...
function UI.Setup:CopyOnClick(index)
